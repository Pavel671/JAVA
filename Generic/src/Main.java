...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Box 1 вес: "+or.getWeight());
        System.out.println("Box 2 вес: "+or1.getWeight());
        System.out.println("Box 3 вес: "+ap.getWeight());
        System.out.println("Box 4 вес: "+ap1.getWeight());
        System.out.println("Box 1 equals box 3: "+or.compare(ap));
        System.out.println("Box 2 equals box 4: "+or1.compare(ap1));
        or.pourTo(or1);
        ap.pourTo(ap1);
        System.out.println("Box 1 вес: "+or.getWeight());
        System.out.println("Box 2 иус: "+or1.getWeight());
    ...
    public static void swap(Object[] arr, int n1, int n2){
        System.out.println("Метод, который меняет два элемента массива местами: "+Arrays.toString(arr));
        Object sw = arr[n1];
        arr[n1]=arr[n2];
        arr[n2]=sw;
    ...
    public static <T> void asList(T[]arr){
        ...
        System.out.println("Метод, который преобразует массив в ArrayList : "+alt+"\n");
    }
}
